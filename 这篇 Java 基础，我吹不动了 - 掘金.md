...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/a35ca1c81e4e4a17be6c152e8b6553b8~tplv-k3u1fbpfcp-watermark.awebp)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/bca2aafa4184448aa796f5a80675f7a4~tplv-k3u1fbpfcp-watermark.awebp)
...
C++ 中模板的实例化会为每一种类型都产生一套不同的代码，这就是所谓的代码膨胀。Java 中并不会产生这个问题。虚拟机中并没有泛型类型对象，所有的对象都是普通类。 （摘自：[blog.csdn.net/fw0124/arti…](https://link.juejin.cn/?target=http%3A%2F%2Fblog.csdn.net%2Ffw0124%2Farticle%2Fdetails%2F42295463%25EF%25BC%2589 "http&#x3A;//blog.csdn.net/fw0124/article/details/42295463%EF%BC%89")
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/745e428048204c09b3f25fa7f3953600~tplv-k3u1fbpfcp-watermark.awebp)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/4a266dcfe99e433db0982653865ff4c3~tplv-k3u1fbpfcp-watermark.awebp)

深入理解反射，可以阅读作者的这篇文章 [学会反射后，我被录取了！（干货）](https://link.juejin.cn/?target=https%3A%2F%2Fmp.weixin.qq.com%2Fs%3F__biz%3DMzkwMDE1MzkwNQ%3D%3D%26mid%3D2247495851%26idx%3D1%26sn%3Dfe53ba6e2f2d1098fb0c8cd82420e885%26chksm%3Dc04ae7f5f73d6ee35caa07a1ecb649d99aba9248e0db1178c0526f524c9f1f66abe37f76a246%26token%3D1680060231%26lang%3Dzh_CN%23rd "https&#x3A;//mp.weixin.qq.com/s?\_\_biz=MzkwMDE1MzkwNQ==&mid=2247495851&idx=1&sn=fe53ba6e2f2d1098fb0c8cd82420e885&chksm=c04ae7f5f73d6ee35caa07a1ecb649d99aba9248e0db1178c0526f524c9f1f66abe37f76a246&token=1680060231&lang=zh_CN#rd")
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/3b9b68e4be4248618c52bab461cdf61d~tplv-k3u1fbpfcp-watermark.awebp)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/10bb49801d5a42d4afa2817f87dd9100~tplv-k3u1fbpfcp-watermark.awebp)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/aba7a675211f4e1aabcdd168bca4823f~tplv-k3u1fbpfcp-watermark.awebp)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/e7842ddd8ae44bbfbd31f14383bdc949~tplv-k3u1fbpfcp-watermark.awebp)

I/O 还可以根据操作对象来进行区分：主要分为

![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/e76311708d43490596273d874e8532f6~tplv-k3u1fbpfcp-watermark.awebp)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/d1605c590f1c41338de08af768740f15~tplv-k3u1fbpfcp-watermark.awebp)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/4beee6bd88ac4f04a416f54f20cc59b0~tplv-k3u1fbpfcp-watermark.awebp)

#### OutputStream

OutputStream 是定义了流式字节输出模式的抽象类。该类的所有方法返回一个 void 值并且在出错情况下引发一个 IOException 异常。它的主要方法定义如下

![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/efc8f54a7d2f4b209e2d9db4e14abe51~tplv-k3u1fbpfcp-watermark.awebp)

#### Reader 类

Reader 是 Java 定义的流式字符输入模式的抽象类。类中的方法在出错时引发 `IOException` 异常。

![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/1510e9cc5449411289766621fc55e0d4~tplv-k3u1fbpfcp-watermark.awebp)

#### Writer 类

Writer 是定义流式字符输出的抽象类。 所有该类的方法都返回一个 void 值并在出错条件下引发 IOException 异常

![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/3f33d85e3e744ef2a7c5e8ad7c59710b~tplv-k3u1fbpfcp-watermark.awebp)
...
深入理解 Java IO ，你可以阅读作者的这篇文章 [深入理解 Java IO](https://link.juejin.cn/?target=https%3A%2F%2Fmp.weixin.qq.com%2Fs%3F__biz%3DMzkwMDE1MzkwNQ%3D%3D%26mid%3D2247495827%26idx%3D1%26sn%3D3fb5ed6663e4ebe90a970d11e00e1a64%26chksm%3Dc04ae7cdf73d6edb041e35b75913c90f3d88d2977d3e76d567766cecb3279f9692846580a9e5%26token%3D1680060231%26lang%3Dzh_CN%23rd "https&#x3A;//mp.weixin.qq.com/s?\_\_biz=MzkwMDE1MzkwNQ==&mid=2247495827&idx=1&sn=3fb5ed6663e4ebe90a970d11e00e1a64&chksm=c04ae7cdf73d6edb041e35b75913c90f3d88d2977d3e76d567766cecb3279f9692846580a9e5&token=1680060231&lang=zh_CN#rd")
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/06eba33995274505846ede518c621cc5~tplv-k3u1fbpfcp-watermark.awebp)

### 大小写敏感

首先，null 是 Java 中的`关键字`，像是 \*\*public、static、final。\*\*它是大小写敏感的，你不能将 null 写成 Null 或 NULL，编辑器将不能识别它们然后报错。

![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/01464ab232264b27a613b437b2f032cf~tplv-k3u1fbpfcp-watermark.awebp)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/2e50e312ee134a888bebc7a5beb5cdec~tplv-k3u1fbpfcp-watermark.awebp)
...
如果文章对你有帮助的话，希望大家给我点个赞哦！！！ 
 [https://juejin.cn/post/7007245485001932814#heading-25](https://juejin.cn/post/7007245485001932814#heading-25)
